      ...
      eraser.prototype = {
         ...
         stroke: function(b, a) {
            this.context.lineWidth = BRUSH_SIZE;
            this.context.strokeStyle = "rgb(" + BACKGROUND_COLOR[0] + ", " + BACKGROUND_COLOR[1] + ", " + BACKGROUND_COLOR[2] + ")";
            this.context.beginPath();
            this.context.moveTo(this.prevMouseX, this.prevMouseY);
            this.context.lineTo(b, a);
            this.context.stroke();
      ...
      const REV = 6,
         BRUSHES = ["chrome","web", "simple", "squares", "ribbon", "eraser", "spray"],
      ...
      var SCREEN_WIDTH = window.innerWidth,
         ...
         mouseY = 0,
         container, foregroundColorSelector, backgroundColorSelector, menu, canvas, flattenCanvas, context, isFgColorSelectorVisible = false,
